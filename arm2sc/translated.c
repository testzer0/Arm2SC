...
int main(int argc, char **argv)
{
    ...
    if (CR(2,REGP(2,2)) < CW(2,REGP(2,2))) {
        ...
        REGP(2,4) = MU(REGP(2,2),CR(2,REGP(2,2)));
    }
...
LC00:
    ...
    if (CR(2,REGP(2,3)) < CW(2,REGP(2,3))) {
        ...
        REGP(2,5) = MU(REGP(2,3),CR(2,REGP(2,3)));
    }
